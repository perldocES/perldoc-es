...
Si desea ver ejemplos de implementaciones de orden de resolución de métodos, consulte C<S_mro_get_linear_isa_c3()> y la sección C<BOOT:> de F<ext/mro/mro.xs>; vea también C<S_mro_get_linear_isa_dfs()> en F<mro_core.c>
