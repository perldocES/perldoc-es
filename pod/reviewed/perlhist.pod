...
Este documento se creó con el objetivo de conservar un registro de las versiones del código fuente de Perl.
...
Peter Martini y Sawyer X.

=head2 ¿CALABAZA?

[de Porting/pumpkin.pod, incluido en la distribución de código fuente de Perl]
...
Nadie podía hacer una copia de seguridad sin tener en su poder la "calabaza de copia de seguridad".

</cita>

El nombre quedó incorporado al acervo cultural de la comunidad.  A la persona que tiene la calabaza en su poder a veces la llamamos I<pumpking> (¿quizás porque una bomba permite mantener el código a flote?) o I<pumpkineer> (¿por ser el que mueve los hilos?).
...
Por ejemplo, la notación "core: 212  29" de la versión 1.000 significa que ocupaba 212 kilobytes en el núcleo, distribuidos en 29 archivos.  Las etiquetas "core".."doc" se describen más abajo.
...
Las etiquetas "core"..."doc" hacen referencia a los siguientes archivos de la distribución de código fuente de Perl.  La notación de glob ** significa recursivamente, (.) significa archivos normales.
...
A continuación se muestran algunas estadísticas para los demás subdirectorios y un archivo de la distribución de código fuente de Perl de algunas versiones más significativas.
