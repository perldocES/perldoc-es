...
de la distribución estable más reciente de Perl, en lugar de esta
versión.
...
Este incremento en el tiempo de carga puede ser problemático cuando la velocidad de inicio es importante, como en I<scripts> de línea de comandos o en el típico I<script> CGI que debe cargarse cada vez que se ejecuta.
...
L<Class::Accessor>, y L<Class::Tiny> para decidir qué sistema de objetos es adecuado para usted.
