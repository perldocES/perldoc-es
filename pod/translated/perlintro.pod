...
Como alternativa, puede colocar al principio del I<script> la siguiente línea:

 #!/usr/bin/env perl

... y ejecutar el I<script> como F</path/to/script.pl>.  Por supuesto, antes deberá marcarlo como ejecutable con el comando C<chmod 755 script.pl> (en Unix).
...
Un I<script> o programa Perl consta de una o varias instrucciones.  Estas instrucciones se escriben directamente en el I<script>.  Es decir, no es necesario utilizar una función C<main()> ni nada similar.
...
También hay dos arrays especiales: C<@ARGV> (los argumentos de línea de comandos pasados al I<script>) y C<@_> (los argumentos pasados a una subrutina).  Se describen en L<perlvar>.
