...
Muchos pequeños errores se han corregido. Scripts que puedan depender de conductas erróneas previas deberán tener en cuenta estas correcciones como cambios incompatibles :-) Se recomienda realizar pruebas de aceptación suficientes para esta versión para estar seguro de que esto no les afecta, antes de poner esa versión en producción.
