...
Como las comillas invertidas no afectan a la salida de error estándar, use la sintaxis del I<shell> del descriptor de archivos (asumiendo que el I<shell> soporte esto) si es que quiere tenerlo en cuenta.
...
Como C<system>, las comillas invertidas ponen el código de salida del proceso hijo en C<$?>.
