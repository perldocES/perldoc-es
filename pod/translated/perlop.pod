...
El contenido del documento incrustado se trata como si la cadena estuviera incrustada entre comillas invertidas.  Así, el contenido se interpola como si estuviera entrecomillado doble y luego ejecutado a través del I<shell>, devolviendo los resultados de la ejecución.
