...
Los I<shell> (especialmente B<csh>) hacen diversos niveles de sustitución en cada línea de comando.  Perl hace sustitución en solo ciertas construcciones, como las comillas dobles, comillas inversas, ángulos, y patrones de búsqueda.
