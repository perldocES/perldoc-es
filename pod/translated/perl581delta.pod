...
Los ejemplos incluidos en L<perlembed> se han revisado para estar al día y ser consistentes: por ejemplo, el uso correcto de PERL_SYS_INIT3() y PERL_SYS_TERM().
