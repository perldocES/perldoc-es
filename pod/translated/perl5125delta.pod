...
Este documento describe las diferencias entre la versión 5.12.4 y la versión 5.12.5.

Si está actualizando desde una versión anterior como la 5.12.3, primero lea L<perl5124delta>, que describe las diferencias entre 5.12.3 y la 5.12.4.
...
Esto es realmente un cambio introducido en Perl 5.12.0, pero no se incluyó en el lanzamiento de L<perl5120delta>.
