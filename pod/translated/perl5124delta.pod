...
Este documento describe las diferencias entre las distribuciones 5.12.3 y 5.12.4.

Si está actualizando desde una distribución anterior como la 5.12.2, primero lea L<perl5123delta>, que describe las diferencias entre 5.12.2 y la 5.12.3. Los principales cambios realizados en 5.12.0 se describen en L<perl5120delta>.
...
El I<script> de prueba F<cpan/CGI/t/http.t> se arregló para trabajar cuando el entorno tiene variables de entorno HTTPS_*, como HTTPS_PROXY.
