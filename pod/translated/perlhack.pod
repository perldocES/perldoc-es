...
=head3 ¿Es la implementación lo suficientemente genérica como para que sea portátil?

Los peores parches hacen uso de características específicas del sistema.  Es altamente improbable que las adiciones no portátiles al lenguaje Perl sean aceptadas.
