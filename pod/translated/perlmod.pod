...
El resultado de crear directamente nuevas entradas en la tabla de símbolos o de modificar cualquier entrada que no sea ya un I<typeglob> no está definido y puede estar sujeto a cambios entre distribuciones de Perl.
