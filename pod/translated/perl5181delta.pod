...
Este documento describe las diferencias entre la versión 5.18.0 y la versión 5.18.1.

Si va a actualizar desde una versión anterior, como la 5.16.0, debe leer primero L<perl5180delta>, donde se describen las diferencias entre las versiones 5.16.0 y 5.18.0.
...
El comando C<man> del depurador se ha corregido. Se rompió en el lanzamiento v5.18.0. Al comando C<man> se le han creado alias, con los nombres C<doc> y C<perldoc>; ahora todo funciona otra vez.

=item *

Ahora, C<@_> es visible de forma correcta, en el depuraor, arreglando una regresión introducida en el depurador de v5.18.0. [RT #118169]
