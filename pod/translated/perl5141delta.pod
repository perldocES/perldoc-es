...
El script de prueba F<lib/locale.t> se ha actualizado para trabajar en la publicación del próximo Lion.
...
Se ha corregido un error que podría causar un error "uso del valor liberado en la iteración" si los próximos dos elementos hash en los que se puede iterar, son borrados. [perl #85026]
