...
=head2 Desempaquetar un volcado de pila
...
y pasar C<$buf> a su rutina de envío. Algunos protocolos demandan que la cuenta debería incluir la longitud de la propia cuenta: simplemente añada 4 a la longitud de datos. (¡Pero asegúrese que lee L<"Longitudes y anchos"> antes de codificar esto!)
...
Probablemente encontrará estos modificadores incluso más útiles si tiene que tratar con estructuras C I<big-> o I<little-endian>. Asegúrese de leer L<"Empaquetar y desempaquetar estructuras de C"> para más información sobre esto.
