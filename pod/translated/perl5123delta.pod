...
Este documento describe las diferencias entre las distribuciones 5.12.2 y 5.12.3.

Si está actualizando desde una distribución anterior como la 5.12.1, primero lea L<perl5122delta>, que describe las diferencias entre 5.12.1 y la 5.12.2.  Los principales cambios realizados en 5.12.0 se describen en L<perl5120delta>.
...
Esto es realmente un cambio introducido en Perl 5.12.0, pero no se incluyó en la distribución de perldelta.
...
Ahora se construye un DTrace aparte, para miniperl. Esto quiere decir que perl puede ser, de nuevo, generado con -Dusedtrace en Solaris.

=item VMS

Una serie de regresiones en VMS han sido corregidas.  Además de una limpieza de menor importancia de cuestionables expresiones en F<vms.c>, los permisos de archivo ya no deberían distorsionarse por la capa PerlIO, y los espurios límites de registro ya no deberían ser introducidos por la capa PerlIO durante la salida.
...
Algunos cambios muy pequeños se hicieron para el proceso de la generación en VOS para mejorar el soporte en esta plataforma.  Nombre de archivo Longer-than-32-character ahora están soportados en OpenVOS, y se genera apropiadamente sin soporte IPv6.
