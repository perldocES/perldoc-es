...
¡ATENCIÓN!  NO use esta función en una L<thread|hebra>.  La configuración regional cambiará en todas las hebras al mismo tiempo, y su hebra debería hacer una pausa -a través de su sistema operativo-, y otra iniciarse. Esa hebra no tendrá la configuración regional que se espera.  En algunas plataformas, existe una condición de carrera que lleva a fallos de segmentación si dos hebras llaman a esta función casi simultáneamente.
