...
Este documento describe las diferencias entre la versión 5.18.4 y la 5.18.2.  B<Por favor, tenga en cuenta:>  Este documento ignora perl 5.18.3, una versión rota que existió solo durante unas horas.

Si va a actualizar desde una versión anterior, como la 5.18.1, debe leer primero L<perl5182delta>, donde se describen las diferencias entre las versiones 5.18.1 y 5.18.2.
