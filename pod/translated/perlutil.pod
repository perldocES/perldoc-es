...
Además de estos dos conversores, hay otro más: F<pod2html> genera páginas HTML a partir de POD.
...
Para convertir programas antiguos a Perl más moderno puede utilizar la utilidad L<pl2pm|pl2pm>, que le ayudará a convertir bibliotecas antiguas de Perl 4 a módulos de Perl 5 modernos.
...
B<piconv> es una versión Perl de B<iconv>, un conversor de codificaciones de caracteres de uso muy extendido en el mundo Unix.  Este script era principalmente una demostración de tecnología en Perl v5.8.0, pero puede usar piconv en lugar de iconv prácticamente en todos los casos.
