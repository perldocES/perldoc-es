...
Los intérpretes de Pod deberían, por defecto, expandir los tabuladores dentro de los párrafos literales a medida de que son procesados, antes de pasarlos al formateador o a otro procesador.  Los intérpretes también pueden permitir una opción que obvie esto.
