...
Pod se integra en los archivos, típicamente en archivos de código fuente Perl, aunque puede escribir un archivo que solo contenga Pod.
...
L<perlpod>, L<perlsyn/"POD: documentación integrada">, L<podchecker>
