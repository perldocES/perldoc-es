...
A partir de v5.20.0, está disponible una sintaxis posfija para usar referencias.  Se comporta tal como se describe en L</Usando referencias>, pero en vez de usar un sigilo prefijado, se usa un sigilo-y-asterisco posfijo.
