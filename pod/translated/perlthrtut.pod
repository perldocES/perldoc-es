...
Reescrito ligeramente por Jörg Walter E<lt>jwalt@cpan.orgE<gt> para ser más conciso sobre el código Perl de hilos seguros.

Reestructurado ligeramente por Elizabeth Mattijsen E<lt>liz@dijkmat.nlE<gt> para enfatizar menos sobre yield().
