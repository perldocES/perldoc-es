...
Puede bloquear arrays y hashes así como escalares.  Bloquear un array, aun así, no bloqueará subsecuentes bloqueos en elementos del array, solo bloquea los intentos sobre el array mismo.
...
Las tres invocaciones de la subrutina operan en sincronización.  El semáforo, aun así, se asegura que sólo un hilo está accediendo a la vez a la variable global.
