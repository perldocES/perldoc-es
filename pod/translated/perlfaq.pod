...
Una vez aprobada, los cambios se mezclan en L<https://github.com/tpf/perlfaq>, el repositorio que nutre L<http://learn.perl.org/faq/>, y se distribuyen con el siguiente lanzamiento de Perl 5.
...
Cuando he intentado ejecutar mi script, obtengo este mensaje. ¿Qué significa?
...
¿Por qué obtengo largos decimales (p. e. 19.9499999999999) en lugar de los números que debería obtener (p. e., 19.95)?
...
¿Cómo quito es escapado de una cadena de caracteres?
...
¿Cómo capitulizo todas las palabras de una línea?
...
¿Cómo comprueba si dos array o hash son iguales?
...
¿Cómo puedo impedir la adición de claves indeseadas en el hash?

=item *

¿Cómo puedo datos binarios de forma correcta?
...
¿Qué significa que las <regex> son avariciosas? ¿Cómo puedo evitarlo?
...
¿Cómo puedo hacer un sleep() o un alarm() que dure menos de un segundo?
...
¿Por qué mi programa con sockets no funciona en System V (Solaris)? ¿Qué significa el mensaje de error "I<Protocol not supported>" (Protocolo no soportado)?
...
¿Cómo puedo llamar a las comillas inversas sin que lo procese el shell?
...
¿Cómo puedo convertir mi I<script> en shell a perl?
...
¿Cómo distingo entre errores del shell y los de perl?
