...
=head2 Asignar y desreferenciar variables.
...
# wordmatch
 ...
 Este programa interpreta el archivo indicado, especificado con C<-f> y
 muestra un análisis sencillo de las palabras que se encuentran en él.  Use el C<-d>
 I<switch> para activar los mensajes de depuración.
 ...
 my $FH = FileHandle->new("< $file")
                               or die("incapaz de abrir el archivo ($file): $!");
...
=head2 Registrar if DEBUG (constante)
