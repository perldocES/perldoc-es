...
L<CPAN> se ha actualizado de la versión 1.9600 a la 1.9600_01.

L<CPAN::Distribution> se ha actualizado de la versión 1.9602 a la 1.9602_01.
...
L<Encode> se ha actualizado de la versión 2.42 a la 2.42_01.

Vea L</Seguridad>.

=item *

L<File::Glob> se ha actualizado de la versión 1.12 a la 1.13.

Vea L</Seguridad>.

=item *

L<PerlIO::scalar> se ha actualizado de la versión 0.11 a la 0.11_01.
