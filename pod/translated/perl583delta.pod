...
join() podría devolver basura cuando la misma instrucción join() fue anteriormente usada para procesar datos de 8 bits habiendo procesado anteriormente datos UTF8, debido a que los indicadores en esa área de trabajo temporal no eran correctamente reinicializadas. Esto ha sido arreglado.
