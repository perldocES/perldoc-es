...
B<Nota:> Desde perl 5.10.1, si la opción B<-C> es usada en la línea C<#!>, también debe especificarse en la línea de comando, debido a que los flujos estándares se inicializan en ese punto, en la ejecución del intérprete perl.
