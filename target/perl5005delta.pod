...
An ANSI C compiler is now B<required> to build perl.  Vea F<INSTALL>.
...
the same directory hierarchy.  Vea F<INSTALL>.
...
other regular expressions.  Vea L<perlop>.
...
A module to pretty print Perl data.  Vea L<Data::Dumper>.
...
A module to look up errors more conveniently.  Vea L<Errno>.
...
DB_File supports version 2.x of Berkeley DB.  Vea C<ext/DB_File/Changes>.
