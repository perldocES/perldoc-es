...
C<charinfo()> ahora funciona en los puntos de código Unificado CJK añadido en las últimas versiones de Unicode.

C<casefold()> devuelve nuevos campos para proporcionar tanto una interfaz más sencilla como una información previa que faltaba. Los campos anteriores se mantienen para mantener la compatibilidad hacia atrás. Se ha vuelto a poner información específica sobre puntos de código Turkic.
