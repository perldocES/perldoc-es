...
Esta sección de las preguntas más frecuentes ofrece respuestas a preguntas relacionadas con las herramientas de programación y el soporte/// para la programación.
...
¿Se ha leído las páginas de manual (man) correspondientes? Here's a brief index:
...
=item L<perlfunc> - Funciones predefinidas en Perl
...
Ahora escriba código Perl válido y se evaluará inmediatamente. You can also examine the symbol table, get stack
...
C<ptkdb>. Está en CPAN, disponible gratuitamente.
...
and subroutine profiling. Está disponible en CPAN y también se puede invocar con el modificador C<-d>:
...
Si necesita crear algún tipo especial de perfilador, en L<perldebguts> se documenta la creación de un depurador personalizado. brian d foy describes the process
...
L<http://www.his.com/~jguyer/Alpha/Alpha8.html> ). Los usuarios de MacOS X también pueden usar editores para Unix.
...
Sí. Perl's garbage collection system takes care of this so
...
Sí. Read L<perlrun> for more information. Some examples follow.
...
En Mac, depende del entorno que se use. The MacPerl
...
No existe una solución general para todo esto. It is a mess.
...
y siga con L<perlxs>, L<xsubpp> y L<perlguts>. Si desea llamar código Perl desde C, lea L<perlembed>, L<perlcall> y L<perlguts>. Don't forget that you can learn a lot from looking at
...
=head2 When I tried to run my script, I got this message. ¿Qué significa?
