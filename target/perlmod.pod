...
Los bloques C<UNITCHECK> se ejecutan inmediatamente después de que se haya compilado la unidad que los definió.  The main program file and each module it loads are
