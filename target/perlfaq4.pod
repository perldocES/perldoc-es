...
=head2 Does Perl have a round() function? ¿Para qué sirven ceil() y floor()? ¿Y las funciones Trig?
...
El redondeo en las aplicaciones financieras puede tener consecuencias graves, y el método de redondeo utilizado debe ser descrito con precisión. In these
...
=head2 Does Perl have a Year 2000 or 2038 problem? ¿Es Perl compatible con los problemas del año 2000?
...
may rearrange the hash table. Consulte la entrada sobre C<each()> en L<perlfunc>.
...
the "removing duplicates" problem described above. Por ejemplo:
