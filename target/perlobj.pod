...
A diferencia de otros lenguajes de programación que ofrecen orientación a objetos, Perl no dispone de una sintaxis especial para construir objetos. Objects are
...
Tenga en cuenta, sin embargo, que (al contrario de lo que ocurre en otros lenguajes de orientación a objetos) no se asegura ni se fuerza la encapsulación en modo alguno. Si desea que los objetos I<sean> realmente opacos debe conseguirlo por sí mismo. This can
...
it can confuse the Perl interpreter. Siga leyendo para obtener más detalles al respecto.>

Perl supports another method invocation syntax called "indirect object"
notation. Esta sintaxis se denomina "indirecta" porque el método aparece antes que el objeto en el que se hace la llamada.
...
Como los métodos C<DESTROY> pueden llamarse en cualquier momento, debe localizar cualquier variable global que pueda actualizarse mediante C<DESTROY>. In
