...
... and run the script as F</path/to/script.pl>.  Por supuesto, antes deberá marcarlo como ejecutable con el comando C<chmod 755 script.pl> (en Unix).
...
=item Otros operadores
 ...
 ..  operador de intervalo (crea una lista de números)
