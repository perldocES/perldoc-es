...
C</$qr/p> was broken in Perl 5.18.0; the C</p> flag was ignored.  Esto ha sido corregido. [perl #118213]
...
unparsed.  Esto ha sido corregido.
...
not interpolate.  Esto ha sido corregido. [perl #45667]

=item *

Perl 5.18.0 inadvertently made dereferenced regular expressions
S<(C<${ qr// }>)> false as booleans.  Esto ha sido corregido.
...
complaining the lookbehind was variable when it wasn't. Esto ha sido corregido. [perl #120600], [perl #120618]. The current fix may be improved
on in the future.
...
to, even when the subroutine was not an lvalue sub.  Esto ha sido corregido.
[RT #117947]
...
the constant to use the built-in keyword instead.  Esto ha sido corregido.
...
package instead.  Esto ha sido corregido.
...
read-only even outside the C<sort>.  Esto ha sido corregido.
...
had a glob assigned to it.  Esto ha sido corregido. [perl #119051]
...
constants (C<for(1) { ... }>).  Esto ha sido corregido. [perl #21979, #78194,
...
modify the value returned by C<ref> in the outer call.  Esto ha sido corregido.
...
between Unicode, byte, and locale semantics.  Esto ha sido corregido.
...
recursion, the filehandle was losing the "$fh" part of the name.  Esto ha sido corregido.
...
being undefined as they should.  Esto ha sido corregido.  [perl #119311]
...
C<use integer>.  Esto ha sido corregido.  [perl #120288]
...
handle were not opened yet.  Esto ha sido corregido.
...
C<require>'s behaviour.  Esto ha sido corregido.
...
superclass.  Esto ha sido corregido. [perl #120694]
...
crashing.  Esto ha sido corregido. [perl #119949]
