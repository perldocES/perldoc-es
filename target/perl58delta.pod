...
Michael Schwern.)  Vea L<Hash::Util>.
...
interpreter threads.  Ver L<threads::shared>.
...
=head2 Módulos y pragmas actualizados y mejorados
...
the original order of appearance in the input array.  Así que
...
C<use warnings qw(FATAL all)> did not work as intended.  Esto ha sido corregido. [561]
...
Las conversiones numéricas no reconocen cambios en el valor de la cadena de caracteres de forma correcta, en determinadas circunstancias. [561]
...
El problema ha sido corregido. [561]
...
Multi-line matches like C<"a\nxb\n" =~ /(?!\A)x/m> were flawed.  Este error ha sido solucionado. [561]

=item *

Use of $& could trigger a core dump under some situations.  Ahora se evita todo esto. [561]
...
"" (blank line) at the end in certain situations.  Esto ha sido corregido. [561]

=item *

Autovivification of symbolic references of special variables described
in L<perlvar> (as in C<${$num}>) was accidentally disabled.  Esto ahora funciona de nuevo. [561]
