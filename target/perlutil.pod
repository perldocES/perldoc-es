...
Por último, F<find2perl> traduce comandos C<find> en sus equivalentes Perl, que usan el módulo L<File::Find|File::Find>. As an example, 
...
B<piconv> es una versión Perl de B<iconv>, un conversor de codificaciones de caracteres de uso muy extendido en el mundo Unix.  This script was primarily a
