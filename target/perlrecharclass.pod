...
they match.  Hay dos conjuntos que quedan afectados.  El primer conjunto es
C<Uppercase_Letter>,
C<Lowercase_Letter>,
y C<Titlecase_Letter>,
todos los cuales coinciden con C<Cased_Letter> bajo una detección C</i>.
El segundo conjunto es
C<Uppercase>,
C<Lowercase>,
y C<Titlecase>,
todos los cuales coinciden con C<Cased> bajo una detección C</i>.
...
should match the sequence C<ss> under C</i> rules.  Por lo tanto,
...
multi-character fold.  Por lo tanto,
...
Care must be taken to ensure that you are getting what you expect.  Por ejemplo:
