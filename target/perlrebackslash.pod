...
as C<Not in [].>
 ...
 \1                Absolute backreference.  No en [].
 \a                Alarm or bell.
 \A                Beginning of string.  No en [].
 \b                Word/non-word boundary. (Backspace in []).
 \B                Not a word/non-word boundary.  No en [].
 \cX               Control-X.
 \C                Single octet, even under UTF-8.  No en [].
                   (Deprecated)
 \d                Character class for digits.
 \D                Character class for non-digits.
 \e                Escape character.
 \E                Turn off \Q, \L and \U processing.  No en [].
 \f                Form feed.
 \F                Foldcase till \E.  No en [].
 \g{}, \g1         Named, absolute or relative backreference.
                   No en [].
 \G                Pos assertion.  No en [].
 \h                Character class for horizontal whitespace.
 \H                Character class for non horizontal whitespace.
 \k{}, \k<>, \k''  Named backreference.  No en [].
 \K                Keep the stuff left of \K.  No en [].
 \l                Lowercase next character.  No en [].
 \L                Lowercase till \E.  No en [].
 \n                (Logical) newline character.
 \N                Any character but newline.  No en [].
 ...
 \Q                Quote (disable) pattern metacharacters till \E.  Not
                   in [].
 \r                Return character.
 \R                Generic new line.  No en [].
 \s                Character class for whitespace.
 \S                Character class for non whitespace.
 \t                Tab character.
 \u                Titlecase next character.  No en [].
 \U                Uppercase till \E.  No en [].
 ...
 \X                Unicode "extended grapheme cluster".  No en [].
 \z                End of string.  No en [].
 \Z                End of string.  No en [].
...
regular expression modifier.  Vea L<perlrecharclass>.
...
categories above. Son los siguientes:
