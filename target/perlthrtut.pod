...
assignment will cause the thread to die. Por ejemplo:
...
C<lock()> on the variable goes out of scope. Por ejemplo:
...
Le Sergent, T. y B. Berthomieu. "Incremental MultiThreaded Garbage
