...
Who supports Perl? ¿Quién lo desarrolla? ¿Por qué es gratis?
...
What machines support Perl? ¿Dónde puedo obtener Perl?
...
I don't have a C compiler. ¿Cómo puedo compilar mi propio intérprete de Perl?
...
I grabbed the sources and tried to compile but gdbm/dynamic loading/malloc/linking/... failed. ¿Cómo puedo hacer que funcione?

=item *

What modules and extensions are available for Perl? ¿Qué es CPAN?
...
What is perl.com? ¿Y Perl Mongers? ¿Y pm.org? ¿Y perl.org? ¿Y cpan.org?
...
When I tried to run my script, I got this message. ¿Qué significa?
...
Does Perl have a round() function? ¿Para qué sirven ceil() y floor()? ¿Y las funciones Trig?
...
Does Perl have a Year 2000 or 2038 problem? ¿Es Perl compatible con los problemas del año 2000?
...
How do I flush/unbuffer an output filehandle? ¿Por qué debo hacer esto?
...
I still don't get locking. I just want to increment the number in the file. ¿Cómo puedo hacer esto?
...
How can I read a single character from a file? ¿Y por el teclado?
