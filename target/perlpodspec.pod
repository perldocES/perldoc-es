...
is a heading.  That text may contain formatting codes.  Ejemplos:
...
below.  Formatting codes are not expanded.  Ejemplos:
...
I<identifier> begins with a colon, I<can> contain commands.  Por ejemplo:
