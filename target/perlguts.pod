...
to do some cleanup before giving control back to Perl.  Por ejemplo:
...
command line switch.  Por ejemplo:
...
No se puede.  This is because UTF-8 data is stored in bytes just like
