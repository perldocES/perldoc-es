...
expression, just as they always have within a string.  Por ejemplo,

    $push = "pop on ";
    print "${push}over";

siempre ha significado imprimir "pop on over", incluso aunque push sea una palabra reservada.  This is generalized to work the same
...
tendrán el mismo efecto.  Esta construcción I<no> es considerada una referencia simbólica cuando se está utilizando C<strict refs>:
