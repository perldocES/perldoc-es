...
Hay dos líneas de desarrollo de perl: una versión de mantenimiento y una versión experimental. The maintenance versions are stable, and
...
Al elegir un lenguaje también debe tener en cuenta los L<recursos|http://www.cpan.org/>, la L<cultura de ejecución de pruebas|http://www.cpantesters.org/>
