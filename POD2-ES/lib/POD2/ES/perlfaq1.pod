...
complementan. Perl 6 no sustituye a Perl 5, y viceversa. 
Vea L</"¿Qué es Perl 6?"> a continuación para obtener más información.
...
to do it" (o TMTOWTDI, que en inglés se suele pronunciar como "tim toady").
Así, la curva de aprendizaje de Perl tiene una pendiente suave (es fácil de
aprender) y larga (si desea seguir profundizando, puede aprender a hacer muchas
cosas).
...
L<cultura de ejecución de pruebas (I<testing>)|http://www.cpantesters.org/> 
